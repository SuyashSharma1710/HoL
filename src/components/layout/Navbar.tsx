      ...
      <div className="max-w-360 mx-auto px-4 lg:px-8 h-24 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4 xl:gap-6">
          ...
          <div className="hidden xl:flex items-center gap-4 text-primary">
            <Link href="https://www.facebook.com/profile.php?id=61591808093320" target="_blank" rel="noopener noreferrer" className="hover:text-secondary transition-transform hover:scale-110">
              <Facebook className="w-5 h-5" />
            </Link>
            <Link href="https://www.instagram.com/harmonyoflife_official/?hl=en" target="_blank" rel="noopener noreferrer" className="hover:text-secondary transition-transform hover:scale-110">
              <Instagram className="w-5 h-5" />
            </Link>
            <Link href="https://www.youtube.com/@Harmonyoflife-01" target="_blank" rel="noopener noreferrer" className="hover:text-secondary transition-transform hover:scale-110">
              <Youtube className="w-5 h-5" />
            </Link>
            <Link href="https://www.linkedin.com/in/harmony-of-life-0-59ba5a413/" target="_blank" rel="noopener noreferrer" className="hover:text-secondary transition-transform hover:scale-110">
              ...
              <SheetContent side="right" className="w-full sm:w-112.5 bg-background/95 backdrop-blur-xl border-l border-primary/10 p-6 sm:p-8 overflow-y-auto flex flex-col">
                ...
                <div className="mt-auto pt-8">
                  ...
                  <div className="border-t border-primary/10 pt-6 flex justify-center gap-6 text-primary">
                    <Link href="https://www.facebook.com/profile.php?id=61591808093320" target="_blank" rel="noopener noreferrer"><Facebook className="w-5 h-5" /></Link>
                    <Link href="https://www.instagram.com/harmonyoflife_official/?hl=en" target="_blank" rel="noopener noreferrer"><Instagram className="w-5 h-5" /></Link>
                    <Link href="https://www.youtube.com/@Harmonyoflife-01" target="_blank" rel="noopener noreferrer"><Youtube className="w-5 h-5" /></Link>
                    <Link href="https://www.linkedin.com/in/harmony-of-life-0-59ba5a413/" target="_blank" rel="noopener noreferrer"><Linkedin className="w-5 h-5" /></Link>
                  </div>
